<?php
    ...
    $nom = $prenom=$numero = $nomError=$prenomError=$numroError= $article=$articleError="";
    ...
    if(!empty($_POST)) 
    {
        ...
        {
            $db = Database::connect();
            $statement = $db->prepare("INSERT INTO acheteur (nom,prenom,numero,article) values(?, ?,?,?)");
            $statement->execute(array($nom,$prenom,$numero,$article));
            Database::disconnect();
...
<html>
  ...
  <body>
    <div class="container info">
           <h1><strong>Acheter un article</strong></h1>
           <br>
            <div class="row">
                <br>
                <form class="form" action="acheteur.php" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-actions">
                        ...
                        <a class="btn btn-primary" href="maforce.html"> Retour</a>
                   </div>
                </form>
            </div>
        </div>   
